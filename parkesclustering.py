...
def create_matrices(inputdir, corpus, datafile, k, m, ktagsfname, mtagsfname, maxtokens):
...
#    global CONF_THRESHOLD
    ...
    if not args.loadmats:
        create_matrices(args.inputdir, args.corpus, args.datafile, int(args.numclustertypes), args.numcontexttypes, args.ktagsfile, args.mtagsfile, args.numtokens)
    else:
